...
TOOL_DEF = {
    ...
    "function": {
        "name": "query_records",
        "description": "當使用者想查詢、列出或檢視他儲存的「記帳/花費」、「待辦事項/任務」、「行程/排程」、「名片/聯絡人」或「筆記/備忘錄」時呼叫此功能。例如：「列出我近期的記帳」、「看一下我的待辦清單」、「查一下王老闆的電話」。",
        "parameters": {
            "type": "object",
            "properties": {
                "category": {
                    ...
                    "description": "要查詢的資料類別。expense(記帳/花費), task(待辦/任務), event(排程/行程), contact(名片/通訊錄/人脈), note(筆記/備忘錄)。"
                },
                "keyword": {
                    "type": "string",
