...
TOOL_DEF = {
    ...
    "function": {
        "name": "query_records",
        "description": "當使用者想查詢、列出或檢視他儲存的「記帳/花費/出金/淨利潤」、「待辦事項/任務」、「行程/排程」、「名片/聯絡人」、「筆記/備忘錄」或「交易日記/打單心得」時呼叫此功能。例如：「列出我近期的記帳」、「花費統計」、「出金統計」、「看一下我的待辦清單」、「查一下王老闆的電話」、「看昨天交易紀錄」。",
        "parameters": {
            "type": "object",
            "properties": {
                "category": {
                ...
                "keyword": {
                    "type": "string",
                    "description": "用來區分查詢類型的關鍵字。查詢出金時填「出金」，查詢花費/支出時填「花費」，查詢特定項目時填該名稱。若只是一般記帳查詢則留空。"
                }
            },
            "required": ["category"]
        }
